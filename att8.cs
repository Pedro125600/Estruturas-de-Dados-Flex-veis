...
namespace att8
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            lista.Inverter();
            Console.WriteLine("Buscar item na lista:");
            int n = int.Parse(Console.ReadLine());

            Console.WriteLine($"{lista.Buscar(ref n)}");

            Console.WriteLine("Lista Dupla:");
            listaDupla.Mostrar();

            lista.Inverter();
            Console.WriteLine("Buscar item na lista dupla:");
            n = int.Parse(Console.ReadLine());

            Console.WriteLine($"{listaDupla.Buscar(ref n)}");

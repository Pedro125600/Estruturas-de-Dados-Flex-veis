...
namespace att11
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            while (cont != 10)
            {
                lista1.InserirFim(rnd.Next(0, 100));
                listaDupla.inserirFim(rnd.Next(0, 100));
                cont++;
            }

            Console.WriteLine($"Tamanho da lista simples {lista1.Tamanho()}");
            Console.WriteLine($"Tamanho da lista dupla {lista1.Tamanho()}");
